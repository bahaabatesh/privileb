...
/**
 * Created by BLOOMAY on 7/3/2017.
 */

public class FeaturedDealsActivity extends AppCompatActivity {
    ...
    private SimpleSideDrawer mNav0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mNav0 == null){
            ...
            txtLogout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    _wsc.logout(FeaturedDealsActivity.this);
                }
            });
            ...
            btnCall.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    final AlertDialog alertDialog = new AlertDialog.Builder(FeaturedDealsActivity.this).create();
                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Call",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    int result = ContextCompat.checkSelfPermission(FeaturedDealsActivity.this, android.Manifest.permission.CALL_PHONE);
                                    if (result == PackageManager.PERMISSION_GRANTED){
                                        Intent intent = new Intent(Intent.ACTION_CALL);
                                        intent.setData(Uri.parse("tel:1514"));
                                        startActivity(intent);
                                    } else {
                                        _wscgeneral.requestPermission(FeaturedDealsActivity.this);
                                        int result_2 = ContextCompat.checkSelfPermission(FeaturedDealsActivity.this, android.Manifest.permission.CALL_PHONE);
            ...
            llAboutPrivileb.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(FeaturedDealsActivity.this, LoginHomeActivity.class);
            ...
            llAllDeals.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(FeaturedDealsActivity.this, FeaturedDealsActivity.class);
                    startActivity(intent);
                }
            });
            ...
            llFavorites.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(FeaturedDealsActivity.this, FavoriteActivity.class);
                    startActivity(intent);
                }
            });
            ...
            llCharities.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(FeaturedDealsActivity.this, CharitiesActivity.class);
                    startActivity(intent);
                }
            });
            ...
            llContactUs.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // contact us
                    Intent intent = new Intent(FeaturedDealsActivity.this, ContactUsActivity.class);
                    startActivity(intent);
                }
            });
        ...
        btnFilter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FeaturedDealsActivity.this, FilterActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnAlldeals.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // contact us
                Intent intent6 = new Intent(FeaturedDealsActivity.this, AllDealsActivity.class);
        ...
        // _wsd.getUserFavoritesFeaturedDeals(this, (ViewGroup) findViewById(R.id.home_deals_main), prefs.getLong(Enums.UserId, 0) + "", "featured_deals", "");
    ...
    {
        super.onResume();
        _wsc.getUserFavoritesFeaturedDeals(this, (ViewGroup) findViewById(R.id.home_deals_main), prefs.getLong(Enums.UserId, 0) + "", "featured_deals", "");
    }
