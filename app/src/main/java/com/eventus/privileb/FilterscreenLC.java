...
public class FilterscreenLC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FilterscreenLC.this, FilterActivity.class);
        ...
        // _wsc.getUserFavoritesFeaturedDeals(this, filterByLocationAndCategoriesView, prefs.getLong(Enums.UserId, 0) + "", "filter_by_location_and_categories", "");

        final EditText editText_both = (EditText) findViewById(R.id.filterscreen_search);
        editText_both.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    _wsc.getUserFavoritesFeaturedDeals(FilterscreenLC.this, (ViewGroup) findViewById(R.id.filterscreen_main), prefs.getLong(Enums.UserId, 0) + "", "filterscreen_location_and_categories", editText_both.getText().toString().trim());
                }
                return false;
            }
        });

        ImageView ivDeleteSearchText_both = (ImageView) findViewById(R.id.filterscreen_cancel_search);
    ...
    public void onResume()
    {
        ...
        _wsc.getUserFavoritesFeaturedDeals(FilterscreenLC.this, (ViewGroup) findViewById(R.id.filterscreen_main), prefs.getLong(Enums.UserId, 0) + "", "filterscreen_location_and_categories", editText1.getText().toString().trim());
    }
