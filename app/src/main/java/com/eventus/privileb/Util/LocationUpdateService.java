...
//        pendingIntent = PendingIntent.getService(getApplicationContext(),0,intent,PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        if (prefs.getBoolean(Enums.Running, false) == false) {
            SharedPreferences.Editor editor = prefs.edit();
            editor.putBoolean(Enums.Running, true);
            editor.commit();
            mGoogleApiClient.connect();
        }
        return START_STICKY;
    ...
    public void onDestroy() {
        ...
        Log.i("stop", "stop");
        SharedPreferences.Editor editor = prefs.edit();
        editor.putBoolean(Enums.Running, false);
        editor.commit();
...
//                .addLocationRequest(mLocationRequestBalancedPowerAccuracy);
    ...
    private void createLocationRequest() {
        ...
        mLocationRequestHighAccuracy.setInterval(Enums.LOCATION_INTERVAL_MILLISECONDS);
        mLocationRequestHighAccuracy.setFastestInterval(Enums.LOCATION_INTERVAL_MILLISECONDS / 10);
...
//        mLocationRequestBalancedPowerAccuracy.setPriority(LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY);
    ...
    public void onLocationChanged(Location location) {
        ...
        // add code here
        SharedPreferences.Editor editor = prefs.edit();
        if (Double.toString(location.getLatitude()).equals("") == false) {
            editor.putString(Enums.CurrentLatitude, Double.toString(location.getLatitude()));
        }
        if (Double.toString(location.getLongitude()).equals("") == false) {
            editor.putString(Enums.CurrentLongitude, Double.toString(location.getLongitude()));
        }
        editor.commit();
        SharedPreferences myPref = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        /* Toast.makeText(this, "LOCATION UPDATED" + Double.toString(location.getLatitude()) + " " + Double.toString(location.getLongitude()),
