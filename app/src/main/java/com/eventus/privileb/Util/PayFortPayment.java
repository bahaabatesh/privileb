...
public class PayFortPayment {
    ...
    //Statics
    private final static String MERCHANT_IDENTIFIER = "CycHZxVj";// "Cyc0HZ9xV6j"; //;
    private final static String ACCESS_CODE = "zx0IPmPy5jp1vAz8Kpg7";// "zx0IPmPy5jp1vAz8Kpg7"; //"Use your registered access code which is generated at the time of regitration at payfort";//"zx0IPmPy5jp1vAz8Kpg7";//;
                                    ...
                                    parameters.put("customer_email", payFortData.customerEmail);
                                            parameters.put("language", payFortData.language);
                                                    parameters.put("merchant_reference", payFortData.merchantReference);
                                                            ...
                                                            parameters.put("payment_option", payFortData.paymentOption);
