...
public class FilterscreenCG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FilterscreenCG.this, FilterActivity.class);
        ...
        final EditText editText_categoriesgo = (EditText) findViewById(R.id.filterscreen_search);
        editText_categoriesgo.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    _wsc.getUserFavoritesFeaturedDeals(FilterscreenCG.this, (ViewGroup) findViewById(R.id.filterscreen_main), prefs.getLong(Enums.UserId, 0) + "", "filter_categories_go",editText_categoriesgo.getText().toString().trim());
                }
                return false;
            }
        });
    ...
    public void onResume()
    {
        ...
        _wsc.getUserFavoritesFeaturedDeals(FilterscreenCG.this, (ViewGroup) findViewById(R.id.filterscreen_main), prefs.getLong(Enums.UserId, 0) + "", "filter_categories_go",editText1.getText().toString().trim());
    }
